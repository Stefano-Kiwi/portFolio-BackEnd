package com.portfolio.stefano.Controller;

import com.portfolio.stefano.Dto.DtoExperiencia;
import com.portfolio.stefano.Entity.Experiencia;
import com.portfolio.stefano.Security.Controller.Mensaje;
import com.portfolio.stefano.Service.ServExperiencia;
...
@CrossOrigin(origins = "https://stefano-frontend.web.app")
public class CExperiencia {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody DtoExperiencia dtoexp){
        ...
        experiencia.setNombreE(dtoexp.getNombreE());    // Busco el nombre en el dto y seteo la experiencia
